...
public class TelaInserirReporter extends javax.swing.JFrame {
    ...
    private Reporter[] vetorDeReporter;
    
    /**
     * Creates new form TelaInserirReporter
     */
    public TelaInserirReporter() {
        initComponents();
    }
    ...
    private void botaoCadastrarReporterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarReporterActionPerformed
        ...
        for (int i = 0; i < vetorDeReporter.length; i++){
            if (vetorDeReporter[i] == null){
                vetorDeReporter[i] = rep;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaInserirReporter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaInserirReporter().setVisible(true);
            }
        });
    }
